...
struct user_ta_head crypt_user_ta_head = {
	.uuid = TA_CRYPT_UUID,
	.name = "optee xtest crypt ta",
...
__attribute__((visibility("default"))) struct user_ta_head *user_ta = &crypt_user_ta_head;
#else
user_ta_register(.uuid = TA_UUID,, .name = "optee xtest crypt ta",
		.flags = TA_FLAG_USER_MODE,
		.create_entry_point = TA_CreateEntryPoint,
		.destroy_entry_point = TA_DestroyEntryPoint,
		.open_session_entry_point = TA_OpenSessionEntryPoint,
